...
async def get_product_by_id(product_id: int, service: ProductsService = Depends()):
...
async def update_product(product_id: int, product_data: ProductsUpdate, service: ProductsService = Depends()):
    return service.update(product_id, product_data)


@router.delete('/{product_id}')
async def delete_product(product_id: int, service: ProductsService = Depends()):
