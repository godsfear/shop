...
class CategoriesService:
    ...
    def _get(self, category_id: int) -> tables.Categories:
    ...
    def get_by_id(self, category_id: int) -> tables.Categories:
    ...
    def update(self, category_id: int, category_data: CategoriesUpdate) -> tables.Products:
