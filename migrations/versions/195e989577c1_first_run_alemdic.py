...
def upgrade() -> None:
    ...
    op.create_index('account_issuer_idx', 'account', ['category', 'code', 'currency', 'issuer_table', 'issuer'], unique=False)
    ...
    op.create_index('company_idx', 'company', ['country', 'code'], unique=False)
    op.create_index('company_nane_idx', 'company', ['country', 'code', 'name'], unique=False)
    ...
    op.create_index('document_idx', 'document', ['category', 'code', 'country', 'series', 'number', 'issue'], unique=True)
    op.create_index('document_issuer_idx', 'document', ['category', 'code', 'issuer_table', 'issuer'], unique=False)
    ...
    op.create_index('message_idx', 'message', ['category', 'code', 'author', 'receiver', 'begins'], unique=False)
    op.create_index('message_receiver_idx', 'message', ['category', 'code', 'receiver', 'begins'], unique=False)
    op.create_index('message_sender_idx', 'message', ['category', 'code', 'author', 'begins'], unique=False)
    ...
    op.create_index('place_name_idx', 'place', ['category', 'code', 'country', 'name'], unique=False)
    ...
    op.create_index('obj_idx', 'property', ['table', 'code', 'object'], unique=False)
    op.create_index('val_dec_idx', 'property', ['table', 'code', 'value_dec'], unique=False)
    op.create_index('val_dt_idx', 'property', ['table', 'code', 'value_dt'], unique=False)
    op.create_index('val_idx', 'property', ['table', 'code', 'value'], unique=False)
    op.create_index('val_int_idx', 'property', ['table', 'code', 'value_int'], unique=False)
    ...
    op.create_index(op.f('ix_rate_table'), 'rate', ['table'], unique=False)
    op.create_index('rate_idx', 'rate', ['category', 'code', 'table', 'object'], unique=False)
    ...
    op.create_index('name_src_idx', 'relation', ['code', 'src', 'trg', 'src_id'], unique=False)
    op.create_index('name_trg_idx', 'relation', ['code', 'src', 'trg', 'trg_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('rate_idx', table_name='rate')
    op.drop_index(op.f('ix_rate_table'), table_name='rate')
    ...
    op.drop_index('document_issuer_idx', table_name='document')
    ...
    op.drop_index('company_idx', table_name='company')
