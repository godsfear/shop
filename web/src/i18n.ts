...
const EN: Record<string, string> = {
  ...
  'Пользователи': 'Users',
  '— из них подтвердили почту': '— of them confirmed email',
  'Персоны': 'Persons',
  'Псевдонимы (выданы)': 'Pseudonyms (issued)',
  'Псевдонимы (свободный пул)': 'Pseudonyms (free pool)',
  'Медицинские записи': 'Medical records',
  'Файлы (блобы)': 'Files (blobs)',
  'Согласия на доступ': 'Access consents',
  'Ключи шифрования': 'Encryption keys',
  'Справочные сущности': 'Reference entities',
