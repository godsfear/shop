...
const EN: Record<string, string> = {
  ...
  'Начало периода не может быть позже окончания.':
    'The period start cannot be later than its end.',
  'записей за период нет': 'no entries in this period',
  ...
  '— выберите группу крови —': '— select blood type —',
  'значение': 'value',
  'Записать': 'Record',
  'Изменить': 'Change',
  'Добавить': 'Add',
  'Изменение группы крови сохранится в истории с датой. Указывайте только лабораторно подтверждённое значение.':
    'The blood type change will be saved in dated history. Enter only a laboratory-confirmed value.',
  'Подтверждаю изменение группы крови': 'I confirm the blood type change',
  'см': 'cm',
  'кг': 'kg',
  'мм рт. ст.': 'mmHg',
  'уд/мин': 'bpm',
...
const ERRORS: Record<string, [string, string]> = {
  ...
  access_log_period_invalid: [
    'начало периода должно быть раньше окончания',
    'the period start must be earlier than its end',
  ],
  ...
  profile_fixed_fact_cannot_close: [
    'профильный показатель можно изменить, но нельзя удалить',
